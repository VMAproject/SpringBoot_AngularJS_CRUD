...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function (a, b, c) {
    ...
    function r(a, b, e) {
        ...
        this.source = a;
        for (var r, s,
                 t; (i = j.exec(a)) && (r = h(i, !1), !(r.segment.indexOf("?") >= 0));)s = f(r.id, r.type, r.cfg, "path"), l += g(r.segment, s.type.pattern.source, s.squash, s.isOptional), n.push(r.segment), m = j.lastIndex;
        t = a.substring(m);
        var u = t.indexOf("?");
        if (u >= 0) {
    ...
    function v(a, e) {
        ...
        function s(a) {
            for (var b = a.split("."), c = y.$current.name.split("."), d = 0,
        ...
        function v(a, e, f, h, l, n, p, q, t) {
            ...
            return x.locals = {resolve: null, globals: {$stateParams: {}}}, y = {
                ...
                for (var J = e.when(G),
                         K = D; K < z.length; K++, F = z[K])G = H[K] = d(G), J = v(F, c, F === b, J, G, f);
